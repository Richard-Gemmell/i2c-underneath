...
private:
    ...
    constexpr static double RISE_V0_to_V0_3 = 0.42;
    // Time to rise from 0.3 Vdd to the Teensy's trigger voltage (0.5 Vdd), as a proportion of the rise time
    constexpr static double RISE_V0_3_to_TRIGGER = 0.40;
    // Time to rise from the Teensy's trigger voltage (0.5 Vdd) to 0.7 Vdd, as a proportion of the rise time
    constexpr static double RISE_TRIGGER_to_V0_7 = 0.60;

    // Time to fall from Vdd to 0.7 Vdd as a proportion of the rise time
    constexpr static double RISE_V1_to_V0_7 = RISE_V0_to_V0_3;
    // Time to fall from 0.7 Vdd to the Teensy's trigger voltage (0.5 Vdd), as a proportion of the rise time
    constexpr static double FALL_V0_7_to_TRIGGER = RISE_V0_3_to_TRIGGER;
    // Time to fall from the Teensy's trigger voltage (0.5 Vdd) to 0.3 Vdd, as a proportion of the rise time
